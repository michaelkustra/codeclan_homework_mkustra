---
title: "Strings & Regex Start Point"
output:
  html_document:
    toc: true
    toc_float: true
...
pattern <- "(?i)[Thought Police]"
str_detect(whole_text, pattern)
```
...
pattern <- "(?i)[big brother]+"
sum(str_detect(whole_text, pattern))
```
...
str_replace_all(whole_text, pattern, replacement = "REDACTED")
...
pattern_secs <- "(?i)department"
str_count(whole_text, "(?i)department")
rep_deps <- str_replace_all(whole_text, pattern_secs, replacement = "sections")
str_count(rep_deps, "(?i)department")

pattern_deps <- "(?i)ministries"
str_count(whole_text, "(?i)ministries")
min_deps <- str_replace_all(whole_text, pattern_deps, replacement = "department")
str_count(min_deps, "(?i)ministries")
