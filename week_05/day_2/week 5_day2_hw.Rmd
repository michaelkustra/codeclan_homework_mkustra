...
female wearers than that of men. (eg correltion coefficient for female > men)
...
#ggplot(backpack_data) +
#  aes(x = backpack_weight, fill = back_problems == 1)+
#  geom_bar()
...
category. For those who reported no such pain, it was closer to equal, however, 
males edged this category.
